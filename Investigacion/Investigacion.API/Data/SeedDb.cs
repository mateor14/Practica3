...
using Investigacion.API.Helpers;
using Investigacion.Shared.Enums;
...
namespace Investigacion.API.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "OAP", "Admin", "felipe@gmail.com","3016429606", "Cr 45 7896", UserType.Admin);
